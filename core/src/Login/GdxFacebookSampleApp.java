...
import Facebook.GDXFacebook;
import Facebook.GDXFacebookCallback;
import Facebook.GDXFacebookError;
import Facebook.GDXFacebookGraphRequest;
import Facebook.GDXFacebookSystem;
import Facebook.JsonResult;
import Facebook.SignInMode;
import Facebook.SignInResult;

public class GdxFacebookSampleApp  extends Game {
    ...
    private boolean lastCBState = false;
...
//    private GDXFacebook gdxFacebook;
    ...
    public GdxFacebookSampleApp(GdxFacebookSampleApp gfsa) {
...
//        checkbox.setWidth(300 * 0.1f);
    ...
    private void autologin() {
        /** perform auto login
         *
         * Ok this is ugly, but GWT HTML5 is single threaded and the Facebook Javascript SDK is loaded
         * asynchronously which takes a few seconds. So we have to wait till this is finished.
         *
         * Thread.sleep(100); within create will not work. (Single threaded, not supported)
         *
         * In a productive environment I recommend to do this while you show your loading screen.
         *
         * */
        if (!autoLoginFinished && prefs.getBoolean("autosignin", false) && gdxFacebook.isLoaded()) {
    ...
    public void render() {
        ...
        if (checkbox.isChecked() != lastCBState) {
            ...
            lastCBState = checkbox.isChecked();
            prefs.flush();
        }
